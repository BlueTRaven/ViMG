...
namespace ViMG.Items
{
    public class ItemMetalLegs : Item
    {
        ...
        public ItemMetalLegs(string material, Color color, Player.AccumulatedStats stats) : base("legs_" + material, Main.assetsManager.GetAsset<Texture2D>("swrod"), new RectangleF(112, 96, 16, 16))
        {
