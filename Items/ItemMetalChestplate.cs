...
namespace ViMG.Items
{
    public class ItemMetalChestplate : Item
    {
        ...
        public ItemMetalChestplate(string material, Color color, Player.AccumulatedStats stats, SetBonus setBonus) : base("chestplate_" + material, Main.assetsManager.GetAsset<Texture2D>("swrod"), new RectangleF(112, 80, 16, 16))
        {
