...
namespace ViMG.Items
{
	public class ItemCube : Item
	{
		...
		public ItemCube(Cube cube, ushort cubeId) : base("item_" + cube.Identifier, Main.assetsManager.GetAsset<Texture2D>("cubes_textures"), 
			cube.GetSourceRect(Cube.RenderPass.Opaque, default, new ChunkMesher.CubeMeshingParameters() { cube = cube, id = cube.Id, faces = MeshHelper.CubeFace.FRONT }, MeshHelper.CubeFace.FRONT))
		{
			this.cubeId = cubeId;
