...
namespace ViMG.Physics
{
    ...
    /// This is a copy-n-paste from Bepu the demos. There is one difference, and that is we operate by blacklist instead of by whitelist;
    /// which is to say, by default, objects of the same group collide with each other, and objects from different groups do not collide with each other.
    /// </summary>
