...
{
    public class ItemRegistryViMG : ItemRegistry
    {
        protected override void DoRegistration()
        {
            ...
            Register(new ItemSwordBlade("iron", colorIron, new Item.MeleeAttackStats(new Item.AttackStats(DamageType.Melee,
                new ActionStats()
                {
                    useTime = 0.85f,
                    useAnimTime = 8f / 60f,
            ...
            Register(new ItemBow("iron", colorIron, new Item.RangedAttackStats(new Item.AttackStats(DamageType.Ranged,
            ...
            Register(new ItemSwordBlade("tin", colorTin, new Item.MeleeAttackStats(new Item.AttackStats(DamageType.Melee,
                new ActionStats()
                {
                    useTime = 1f,
                    useAnimTime = 8f / 60f,
            ...
            Register(new ItemBow("tin", colorTin, new Item.RangedAttackStats(new Item.AttackStats(DamageType.Ranged, 1, 2, Cube.CUBE_SCALE), Cube.CUBE_SCALE * 15f, 1f)));
            Register(new ItemPickaxeHead("copper", colorCopper, new ItemPickaxeHead.PickaxeStats(0.475f, 0, 1, 0, 0, 0)));
            Register(new ItemSwordBlade("copper", colorCopper, new Item.MeleeAttackStats(new Item.AttackStats(DamageType.Melee,
                new ActionStats()
                {
                    useTime = 0.95f,
                    useAnimTime = 8f / 60f,
            ...
            Register(new ItemBow("copper", colorCopper, new Item.RangedAttackStats(new Item.AttackStats(DamageType.Ranged, 1, 2, Cube.CUBE_SCALE), Cube.CUBE_SCALE * 15f, 1f)));
            Register(new ItemPickaxeHead("bronze", colorBronze, new ItemPickaxeHead.PickaxeStats(0.575f, 0, 1, 1, 1, 0)));
            Register(new ItemSwordBlade("bronze", colorBronze, new Item.MeleeAttackStats(new Item.AttackStats(DamageType.Melee,
                new ActionStats()
                {
                    useTime = 0.9f,
                    useAnimTime = 8f / 60f,
            ...
            Register(new ItemBow("bronze", colorBronze, new Item.RangedAttackStats(new Item.AttackStats(DamageType.Ranged, 0.95f, 3, Cube.CUBE_SCALE), Cube.CUBE_SCALE * 18f, 0.85f)));
