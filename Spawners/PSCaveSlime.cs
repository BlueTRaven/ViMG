...
namespace ViMG.Spawners
{
    public class PSCaveSlime : PassiveSpawner
    {
        ...
        public PSCaveSlime(EntityManager entityManager) : base(0.5f, 1f / 5f,
            new Rectangle3D(new Vector3(112, 0, 112) * Cube.CUBE_SCALE, new Vector3(512 - 112, 512, 512 - 112) * Cube.CUBE_SCALE), Cube.CUBE_SCALE * 10f)
        {
