...
namespace ViMG.TracyImpl
{
    public static class Tracy
    {
        ...
        {
#if !NOTRACY
            TracyNative.PInvoke.TracyEmitFrameMark(null);
#endif
        }
        ...
        public struct Zone : IDisposable
        {
            ...
            public Zone(TracyNative.PInvoke.TracyCZoneContext context)
            {
            ...
            {
#if !NOTRACY
                TracyNative.PInvoke.TracyEmitZoneEnd(context);
#endif
            }
        }

        public static Zone BeginZone(TracyColor? color = null, string name = null, [CallerMemberName] string functionName = "", [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
        {
#if NOTRACY
            return new Zone();
#else
            ...
            if (color != null)
            {
                TracyNative.PInvoke.TracyEmitZoneColor(ctx, (uint)color);
            }
