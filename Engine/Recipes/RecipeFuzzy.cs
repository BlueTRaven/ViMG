...
namespace ViMG.Recipes
{
	public class RecipeFuzzy : Recipe
	{
        ...
        public RecipeFuzzy(string identifier, IRecipeCatalyst catalyst, ItemInstance[] layout, ItemInstance[] outputs, int weight = 1) : 
			base(identifier, catalyst, layout, outputs, weight == 1 ? layout.Length : weight)
		{
        }
