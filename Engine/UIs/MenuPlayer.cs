...
namespace ViMG.UIs
{
   ...
   //         }
			...
			if (opened)
			{
				...
				{
                    GlobalState.gameStateManager.GetCurrentGameState().PushMenu(new MenuRecipeBook(gsManager, GlobalState.Registry.RecipeRegistry.catalystByName["Inventory"], new ItemInstance()));
				}
