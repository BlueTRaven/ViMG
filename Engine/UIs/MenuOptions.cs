...
namespace ViMG.UIs
{
    public class MenuOptions : Menu
    {
        ...
        public override void Update(double deltaTime)
        {
            ...
            /*Options.SMAAThresholdChanged = UIWidgets.MakeSlider(new UI.ButtonConstructionParameters(new RectangleF(pos, 32, 32), GlobalState.assetsManager.GetAsset<Texture2D>("ui_buttons"),
                new RectangleF(64, 64, 32, 32), new RectangleF(96, 64, 32, 32), new RectangleF(96, 64, 32, 32)),
                new UI.TextureConstructionParameters(new RectangleF(0, 0, 128, 32), GlobalState.assetsManager.GetAsset<Texture2D>("ui_buttons"), new RectangleF(0, 96, 128, 32)),
                128, ref smaaThreshold);

            if (UI.MakeButton(new UI.ButtonConstructionParameters(new RectangleF(pos + new Vector2(128, 0), 32, 32), GlobalState.assetsManager.GetAsset<Texture2D>("ui_buttons"),
