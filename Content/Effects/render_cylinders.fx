...
{
	nointerpolation float3 Position : TEXCOORD0;
	nointerpolation float Radius : TEXCOORD1;
	nointerpolation uint2 PackedOrientation : TEXCOORD2;
	nointerpolation float HalfLength : TEXCOORD3;
	nointerpolation uint PackedColor : TEXCOORD4;
};
