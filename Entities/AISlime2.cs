...
{
    public class AISlime2<T> : IHitboxOwner where T : Entity, IHasStats
	{
		...
		public AISlime2(T entity, Rectangle3D touchHitboxBounds, NoticeHandler<Player> noticeHandler, BuffManager buffManager, int maxHealth)
		{
